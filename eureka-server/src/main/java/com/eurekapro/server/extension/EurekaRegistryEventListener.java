package com.eurekapro.server.extension;

import com.eurekapro.server.dashboard.RegistrySupport;
...
public class EurekaRegistryEventListener {
  ...
  public EurekaRegistryEventListener(RegistrySupport registrySupport) {
  ...
  private PeerAwareInstanceRegistry currentRegistry() {
    return registrySupport.registry();
  }
}
